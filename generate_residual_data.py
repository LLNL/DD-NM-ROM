...
parser.add_argument("--nlam", default=20, type=int, 
...
print('\nComputing residual snapshots with the following parameters:')
print(f'nx        = {nx}')
print(f'ny        = {ny}')
...
save_dict = {'parameters': Mu,
             'snapshots': snapshots,
             'residuals': residuals}
file = save_dir+f'residual_nx_{nx}_ny_{ny}_mu_{viscosity}_Nsamples_{len(Mu)}.p'
