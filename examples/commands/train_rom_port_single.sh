...
#BSUB -W 8:00               #walltime in hours:minutes
#BSUB -e train_rom_port_single_err.txt      #stderr
#BSUB -o train_rom_port_single_out.txt      #stdout
#BSUB -J train_rom_port_single          #name of job
...
# Commands
# --------
python ./../scripts/driver_train_rom_port_single.py --nx 480 --ny 24 --port_ld 2 --port_row_nnz 3 --port_row_shift 3 --act_type Sigmoid --batch 64 --gpu_idx 2 \
