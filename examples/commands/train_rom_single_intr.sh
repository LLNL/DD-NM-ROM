...
#BSUB -e train_rom_single_intr_err.txt      #stderr
#BSUB -o train_rom_single_intr_out.txt      #stdout
#BSUB -J train_rom_single_intr          #name of job
...
# Commands
# --------
python ./../scripts/driver_train_rom_single.py --nx 480 --ny 24 --intr_ld 12 --intf_ld 8 --act_type Swish --batch 64 --intr_only --gpu_idx 0 \
