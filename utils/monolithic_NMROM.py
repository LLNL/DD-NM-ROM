...
from utils.monolithic_LSROM import select_sample_nodes
...
class monolithic_NMROM:
    ...
    def solve(self, w0, tol=1e-6, maxit=20, print_hist=False):
        w, conv_hist, step_hist, iter = gauss_newton(self.res_jac, w0, tol=tol, maxit=maxit, print_hist=print_hist)
